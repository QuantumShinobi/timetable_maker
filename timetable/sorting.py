#inp = {"teacher": {"subj", "[1, 2, 3]", "name"}, "teacher2": {''}}
...
for a in range(0, no_of_teachers, 1):
    ...
    for q in range(0, len(kt), 1):
        if kt[q] == 1:
            g1 = g1 + [{teacher_names[a]: grades_subj[teacher_names[a]][kt[q]]}]
        elif kt[q] == 2:
            g2 = g2 + [{teacher_names[a]: grades_subj[teacher_names[a]][kt[q]]}]
        elif kt[q] == 3:
            g3 = g3 + [{teacher_names[a]: grades_subj[teacher_names[a]][kt[q]]}]
        elif kt[q] == 4:
            g4 = g4 + [{teacher_names[a]: grades_subj[teacher_names[a]][kt[q]]}]
        elif kt[q] == 5:
            g5 = g5 + [{teacher_names[a]: grades_subj[teacher_names[a]][kt[q]]}]
        elif kt[q] == 6:
            g6 = g6 + [{teacher_names[a]: grades_subj[teacher_names[a]][kt[q]]}]
        elif kt[q] == 7:
            g7 = g7 + [{teacher_names[a]: grades_subj[teacher_names[a]][kt[q]]}]
        elif kt[q] == 8:
            g8 = g8 + [{teacher_names[a]: grades_subj[teacher_names[a]][kt[q]]}]
        elif kt[q] == 9:
            g9 = g9 + [{teacher_names[a]: grades_subj[teacher_names[a]][kt[q]]}]
        elif kt[q] == 10:
            g10 = g10 + [{teacher_names[a]: grades_subj[teacher_names[a]][kt[q]]}]
        elif kt[q] == 11:
            g11 = g11 + [{teacher_names[a]: grades_subj[teacher_names[a]][kt[q]]}]
        elif kt[q] == 12:
            g12 = g12 + [{teacher_names[a]: grades_subj[teacher_names[a]][kt[q]]}]
